...
def generatePath(q,startEndCoor, nodesExplored, radiusClearance, numIterations=30000):
    ...
    for i in range(numIterations):
        ...
        if distance(newNode.state, [gx, gy]) <= 0.1:
    ...
    if not isSafe(startCoor, res, clearance + robotRadius) or not isSafe(goalCoor, res, clearance + robotRadius):
        ...
        if success:
            ...
            while draw:
                ...
                np.savetxt("rrt_controls.txt", control_data, delimiter=',')
